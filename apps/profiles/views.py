...
class ProfileView(APIView):
    ...
    @extend_schema(
            ...
            tags=tags,
            request={
                "multipart/form-data": serializer_class
            }
    )
...
class ShippingAddressesView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        shipping_addresses, _ = ShippingAddress.objects.get_or_create(
            user=user, **data
        )
        serializer = self.serializer_class(shipping_addresses)
        return Response(
...
class OrdersView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            "This endpoint return all orders for a particular user"
        ),
        tags=tags
    )
    def get(self, request):
