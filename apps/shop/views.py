...
from apps.shop.serializers import (
    ...
    OrderItemSerializer, ToggleCartItemSerializer,
...
class ProductsBySellerView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            "This endpoint returns all products in a pariculer seller"
        ),
        tags=tags
    )
    def get(self, request, *args, **kwargs):
...
class CartView(APIView):
    ...
    @extend_schema(
        ...
        description=(
            "This endpoint returns all items in a uxer cart"
        ),
        tags=tags
    )
    def get(self, request, *args, **kwargs):
    ...
    @extend_schema(
        ...
        description=(
            ...
            "an item in cart. If quantity is 0, the item is removed from cart"
        ),
        tags=tags,
...
class CheckoutView(APIView):
    ...
    @extend_schema(
        summary="Checkout",
        description=(
            "This endpoint allows a user to create an order through which\n"
            "payment can then be made through"
        ),
        tags=tags,
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Получаем информацию о доставке на основе
        # идентификатора доставки, введенного пользователем
